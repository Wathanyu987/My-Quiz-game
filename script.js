    ...
    easy: [
        {
            ...
            choices: ["ก. ลำโพง", "ข. กล้องเว็บแคม", "ค. เครื่องพิมพ์", "ง. จอภาพ"],
        ...
        },
        {
            ...
            choices: ["ก. Microsoft Excel", "ข. โปรแกรม Paint", "ค. File Explorer", "ง. Google Chrome"],
        ...
        },
        {
            ...
            choices: ["ก. ROM", "ข. Hard Drive", "ค. SSD", "ง. RAM"],
        ...
        },
        {
            ...
            choices: ["ก. แบตเตอรี่เสื่อม", "ข. ติดตั้งโปรแกรมป้องกันไวรัส", "ค. ติดไวรัสหรือมัลแวร์", "ง. RAM เต็ม"],
        ...
        },
        {
            ...
            choices: ["ก. ตั้งรหัสผ่านที่ซับซ้อน", "ข. แชร์ข้อมูลส่วนตัวของผู้อื่นโดยไม่ได้รับอนุญาต", "ค. ใช้ VPN เพื่อเข้าถึงเว็บไซต์", "ง. ออกจากระบบทุกครั้งหลังใช้งาน"],
        ...
        },
        {
            ...
            choices: ["ก. Microsoft PowerPoint", "ข. Microsoft Word", "ค. Microsoft Excel", "ง. Adobe Photoshop"],
        ...
        },
        {
            ...
            choices: ["ก. ไมโครโฟน", "ข. เครื่องสแกน", "ค. ลำโพง", "ง. แฟลชไดรฟ์"],
        ...
        },
        {
            ...
            choices: ["ก. รีบตอบกลับทันทีเพื่อรับรางวัล", "ข. คลิกที่ลิงก์ในอีเมลเพื่อตรวจสอบ", "ค. ลบอีเมลนั้นทิ้งและไม่ตอบกลับ", "ง. ส่งต่อให้เพื่อนเพื่อขอคำแนะนำ"],
        ...
        },
        {
            ...
            choices: ["ก. ฮาร์ดดิสก์", "ข. การ์ดจอ", "ค. เมนบอร์ด", "ง. พาวเวอร์ซัพพลาย"],
        ...
        },
        {
            ...
            choices: ["ก. ทำให้คอมพิวเตอร์บูทเร็วขึ้น", "ข. ช่วยประหยัดค่าอินเทอร์เน็ต", "ค. ป้องกันข้อมูลสูญหายจากความเสียหายหรือไวรัส", "ง. เพิ่มพื้นที่ว่างใน RAM"],
...
function startTimer() {
    ...
    function animateTimer(currentTime) {
        ...
        if (timeLeft <= 0) {
            ...
            setTimeout(() => {
                // นี่คือส่วนที่เรียก Pop-up เมื่อหมดเวลา
                if (confirm("คุณแพ้แล้ว! เริ่มเกมใหม่หรือไม่?")) {
                    startGame();
                } else {
                    showScreen("start");
